                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                  <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                      ...
                      type="text"
                      placeholder="Contoh: Demi Azka dan Demi Istri"
                  ...
                  <div class="w-full px-3">
                    ...
                    <input
                      ...
                      v-model="campaign.data.PerksEdit"
                    />
                  </div>
                  <div class="w-full px-3">
                    <label
...
export default {
  ...
  async asyncData({ $axios, params }){
    const campaign = await $axios.$get('/api/v1/campaigns-edit/' + params.id)
    return { campaign }
  },
      ...
      try {
        let response = await this.$axios.$put(
          '/api/v1/campaigns/'+ this.$route.params.id, 
          {
            ...
            Perks: this.campaign.data.PerksEdit,
          }
        )
        this.$router.push({
