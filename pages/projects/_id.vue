<template>
    <div class="project-page">
      <section class="project-header pt-5">
        <div class="container mx-auto relative delapanpuluh">
          <Navbar />
        </div>
      </section>
      <section class="container project-container mx-auto -mt-56" style="width:80%;">
        <div class="flex mt-3">
              ...
              >
                <figure class="item-thumbnail">
                  <img
                    ...
                    @click="changeImage('http://localhost:8080/' + image.image_url)"
                    alt=""
                    class="rounded-20 w-full h-40"
                  />
                </figure>
              </div>
            </div>
          ...
          <div class="w-1/4">
            ...
            >
              ...
              <div class="flex mt-3">
                <div class="w-1/4">
                  <img
                    :src="'http://localhost:8080/' + campaign.data.User.image_url"
                    alt=""
      ...
      <section class="container mx-auto pt-8 delapanpuluh">
...
export default {
  ...
  mounted(){
    this.default_image = 'http://localhost:8080/' + this.campaign.data.image_url
  }
}
</script>